        ...
        >
          ...
          <Grid item xs={11} md={3.5}>
            <Item sx={{ bgcolor: 'primary.main', color: 'white'}}>
              ...
              {/* =============== === ACCORDIAN === ============*/}
              <Accordion sx={{bgcolor: 'primary.dark', color: "primary.contrastText"}}>
                <AccordionSummary
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  <Typography>
                    This is a battleship game I created using HTML, CSS, and JavaScript. Contains a custom AI to make it more challenging.
                  </Typography>
                  <br/>
                  <Button 
          ...
          <Grid item  xs={11} md={3.5}>
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              <Image src={require("../images/markup_editor_screenshot.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  <Typography>
                    This app allows you to see your HTML and CSS updates real-time.
                  </Typography>                  <br/>
                  <Button 
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/drum-machine_screenshot.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a drum machine program I created using HTML, CSS, and JavaScript on a React framework.                  
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images//calculator_screenshot.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a calculator I created using JavaScript, HTML, CSS on a React framework.                  
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/clock_screenshot.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is timer I made that counts down work session time and break times using Javascript, HTML, and CSS on a React framework.                  
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/Portfolio_screenshot_D-M.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is an app I created to help make a decision when it comes food. I used JavaScript, HTML, and CSS on a React framework.                
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/quote-gen_screenshot.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a React app I made that generates a random motivational quote.               
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/light_switch.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a React app I made that allows you to create or remove any number of lightswitches and independently flip the light on or off on each one.              
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/robot-translator.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This takes a user's input and outputs it on each individual robot module and then modifies it based on module parameters.             
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/treasurehunt.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    A game I created where the player has to find the treasure to win. The player loses if they find the bomb.             
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/mad-libs.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a React app I created that takes the inputs of the user and turns it into a mad lib.                  
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/rock_paper_scissors.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a rocks, paper, and scissors game I created using HTML, CSS, and JavaScript.                  
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
            ...
            <Item sx={{ bgcolor: 'primary.main', color: 'white' }}>
              ...
              <Image src={require("../images/Willis_Deluxe_Detail_Logo.webp")} />
                ...
                <AccordionDetails sx={{bgcolor: 'secondary.main', color: "primary.contrastText"}}>
                  {/*==> Description Text <== ===============================*/}
                  <Typography>
                    This is a Webpage I created for a family member's car detailing business.                  
                  </Typography>                  
                  <br/>
                  <Button
                    /*==> URL Link <== =======================================*/  
