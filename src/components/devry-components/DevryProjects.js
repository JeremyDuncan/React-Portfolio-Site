        ...
        >
          <Grid item xs={10} sm={10} md={5} lg={5} xl={5.5}>
            ...
            >
              {/*==> Image Link <== ===*/}
              <Image
                src={require("../../images/devry-images/data-structures.webp")}
                sx={{ borderRadius: "5px" }}
              />
            </Item>
          </Grid>
          ...
          >
            <Item sx={{ maxWidth: "900px" }} elevation={12}>
              ...
              <Button
                ...
                href="https://drive.google.com/file/d/1vyRzjmeAOtjm0wzWIB4jy-1GyRldLyQm/view?usp=sharing"
                target="_blank"
                rel="noopener"
                // href={MyResume}
                // download
          ...
          >
            <Item sx={{ maxWidth: "900px" }} elevation={12}>
              ...
              >
                ...
                project I walk you through fundamental cloud computing concepts
          ...
          >
            <Item sx={{ maxWidth: "900px" }} elevation={12}>
              ...
              >
                ...
                project I walk you through fundamental IoT concepts while using
                Arduino components to make an automated home security system.
              </Typography>
              <br />
              <Button
                sx={{ color: "button.textLight" }}
